        ...
        stage('init'){
            steps{
                script{
                    ...
                    //sh "git clone https://github.com/divypatel/springboot-jenkins.git"
                }
            }
        }
        stage('config'){
        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t divypatel/spring-boot:${IMAGE_NAME} ."
                    }
            }
        }
      stage('test') {
        ...
        // }
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push divypatel/spring-boot:${IMAGE_NAME}"
                }}
